...
namespace Labs.Lab2
{
    ...
    //  L22T5 Set up vertex sahder to use view matrix and set view matrix in new OnKeyPress function
    //  L22T6 Refactos camera code and eliminated magic numbers 
    public class Lab2_2Window : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //Vector3 eye = new Vector3(0.5f, 0.5f, 0.5f);
            //Vector3 lookAt = new Vector3(0, 0, 0);
            //Vector3 up = new Vector3(0, 1, 0);
            //Matrix4 matView = Matrix4.LookAt(eye, lookAt, up);
            //GL.UniformMatrix4(uViewLocation, true, ref matView);
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Matrix4 m3 = Matrix4.CreateRotationZ(0.8f);
            m1 = m1 * m3;
            ...
            m4 = m4 * m2;
            GL.UniformMatrix4(uModelLocation2, true, ref m4);
